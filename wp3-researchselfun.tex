\begin{workpackage}{Research and develop the Gaia selection function}
  ...
  \begin{wpdeliverables}
    ...
    \wpdeliverable[40]{UCAM}{R}{PU}{Documentation of the top level Gaia selection functions (also to be submitted as paper to a peer-reviewed journal).}\label{dev:wp3finalselfun}
    ...
    \wpdeliverable[40]{UCAM}{R}{PU}{Documentation of the spectroscopic Gaia selection functions (also to be submitted as paper to a peer-reviewed journal).}\label{dev:wp3finalspectro}
    ...
    \wpdeliverable[40]{UCAM}{R}{PU}{Documentation of the specialized Gaia selection functions (also to be submitted as paper to a peer-reviewed journal).}\label{dev:wp3finalspecial}
