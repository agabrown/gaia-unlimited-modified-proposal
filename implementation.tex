...
\begin{itemize}
    ...
    \item NOTE: As audit costs were not listed in the original proposal for MPIA and UCAM, the travel costs for each of these partners has been lowered by 2000\EUR. This amount was then added to `other goods and services' in order to keep the total budget fixed. Thus travel costs for MPIA will be \EUR~$34\,250$ and for UCAM \EUR~$31\,750$.
\end{itemize}
