  ...
  \begin{wpobjectives}
    ...
    \begin{description}
      \item[A. Binary stars in Gaia] {
        ...
        \textsf{Aspects tested: overall Gaia selection function; spectroscopic Gaia selection function; specialized Gaia selection function: deliverables \ref{dev:wp3version1selfun}, \ref{dev:wp3version1spectro}, \ref{dev:wp4prototypev1}, \ref{dev:wp4prototypev2}.}
        }
...
%    }
     ...
     \item[C. Mapping non-axisymmetric structures of the Milky Way via Cepheids]
        ...
        \textsf{Aspects tested: selection function of variability-classified objects in the Gaia catalogue; cross-catalogue selection function; combination of Gaia selection function with (externally determined) 3D dust map: deliverables \ref{dev:wp3version1selfun}, \ref{dev:wp3version1special}, \ref{dev:wp5v2}, \ref{dev:wp4prototypev1}, \ref{dev:wp4prototypev2}}
     }
