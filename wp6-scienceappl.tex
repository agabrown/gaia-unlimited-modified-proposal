...
%    }
  ...
  \begin{wpdeliverables}
    \wpdeliverable[20]{ULEI}{R}{CO}{Progress report on science application A.}\label{dev:wp6caseApr}
    \wpdeliverable[20]{MPIA}{R}{CO}{Progress report on science application B.}\label{dev:wp6caseBpr}
    \wpdeliverable[20]{INAF}{R}{CO}{Progress report on science application C.}\label{dev:wp6caseCpr}
    \wpdeliverable[20]{UCAM}{R}{CO}{Progress report on science application D.}\label{dev:wp6caseDpr}
