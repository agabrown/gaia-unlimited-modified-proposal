...
\begin{workpackage}{Management}
  ...
  \begin{wpdeliverables}
    ...
    The deliverables of this work package are the data management plan, the web-portal for access to {\acro} tools and data, and the organisation of the {\acro} plenary meetings (\secref{sec:procedures}) and community workshops.

    \wpdeliverable[1]{ULEI}{OTHER}{CO}{Kick-off meeting (plenary). The minutes of meeting will be delivered as a record that the meeting took place.}\label{dev:wp1kickoff}
    \wpdeliverable[6]{ULEI}{R}{PU}{Data management plan.}\label{dev:wp1datamanagement}
    \wpdeliverable[21]{ULEI}{OTHER}{PU}{Community workshop no.\ 1 and mid-term meeting (plenary).}\label{dev:wp1midtterm}
    \wpdeliverable[22]{ULEI}{R}{PU}{Report no.\ 1 summarizing community feedback on {\acro} tools.}\label{dev:wp1feedback1}
    \wpdeliverable[32]{ULEI}{OTHER}{PU}{Community workshop no.\ 2.}\label{dev:wp1community}
    \wpdeliverable[33]{ULEI}{R}{PU}{Report no.\ 2 summarizing community feedback on {\acro} tools.}\label{dev:wp1feedback2}
    \wpdeliverable[41]{ULEI}{OTHER}{PU}{Community workshop no.\ 3 and closing meeting (plenary).}\label{dev:wp1closing}
  \end{wpdeliverables}
