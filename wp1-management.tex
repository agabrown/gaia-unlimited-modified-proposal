...
\begin{workpackage}{Management}
  ...
  \begin{wpdeliverables}
    ...
    \wpdeliverable[6]{ULEI}{DEC}{PU}{First version of web-portal for {\acro}.}\label{dev:wp1webportalv1}
    \wpdeliverable[20]{ULEI}{DEC}{PU}{Second version of web-portal for {\acro}, ready for testing by community.}\label{dev:wp1webportalv2}
    \wpdeliverable[21]{ULEI}{OTHER}{PU}{Community workshop and mid-term meeting (plenary).}\label{dev:wp1midtterm}
    \wpdeliverable[22]{ULEI}{R}{PU}{Report summarizing community feedback on {\acro} tools.}\label{dev:wp1feedback1}
    \wpdeliverable[31]{ULEI}{DEC}{PU}{Third version of web-portal for {\acro}, including feedback from community.}\label{dev:wp1webportalv2}
    \wpdeliverable[32]{ULEI}{OTHER}{PU}{Community workshop.}\label{dev:wp1community}
    \wpdeliverable[23]{ULEI}{R}{PU}{Second report summarizing community feedback on {\acro} tools.}\label{dev:wp1feedback2}
    \wpdeliverable[40]{ULEI}{DEC}{PU}{Final version of web-portal for {\acro}.}\label{dev:wp1webportal}
