\begin{workpackage}{Practical implementation and dissemination of the Gaia selection function}
  ...
  \begin{wpdescription}
    ...
    \wptask{INAF}{MPIA, UCAM, ULEI, MONA}{7}{\duration}{Implementation of tools for combined selection functions}{
  ...
  \begin{wpdeliverables}
    ...
    \wpdeliverable[12]{ULEI}{R}{CO}{Report with detailed scoping of the development and implementation effort.}\label{dev:wp4year1report}
